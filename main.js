...
var $author$project$Main$init = {hoveredPaper: $elm$core$Maybe$Nothing, noGif: $elm$core$Set$empty};
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('French Government Scholarship (France Excellence Japon)')
										]))
								])),
							$elm$html$Html$text(', '),
							A2(
...
var $author$project$Main$headerSection = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$headerSection,
