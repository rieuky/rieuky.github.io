...
{
	if (region.Z.C === region.ad.C)
	{
		return 'on line ' + region.Z.C;
	}
	return 'on lines ' + region.Z.C + ' through ' + region.ad.C;
}
...
var $author$project$Main$getStrings = function (lang) {
	if (!lang) {
		return {I: 'JST Support for Pioneering Research Initiated by the Next Generation (SPRING)', J: ', Apr. 2025 – Mar. 2026', K: 'French Government Scholarship (France Excellence Japon)', L: ', Sep. 2019 – Sep. 2021', M: 'JSPS Research Fellow for Young Scientists (DC2)', N: ', Apr. 2026 – Mar. 2028', O: 'Fellowships and Scholarships', P: 'CSS: ', Q: 'Written in ', R: ' (Oral Presentation)', S: 'A learning-based homotopy-aware path planning method for a tethered mobile robot to avoid cable-obstacles and cable-robot contacts while navigating to goals.', T: 'A path refinement method for a tethered mobile robot to avoid cable-obstacle contact by considering path curvature and distance from cable base.', U: 'Publications'};
	} else {
		return {I: 'JST次世代研究者挑戦的研究プログラム（SPRING）', J: '、2025年4月 – 2026年3月', K: 'フランス政府奨学金（フランス・エクセレンス・ジャポン）', L: '、2019年9月 – 2021年9月', M: '日本学術振興会特別研究員（DC2）', N: '、2026年4月 – 2028年3月', O: '奨学金・フェローシップ', P: 'CSS参考: ', Q: '作成言語: ', R: '（口頭発表）', S: 'テザー付き移動ロボットがゴールへ向かう際に、ケーブルと障害物の接触およびケーブルとロボット本体の接触を回避するための、学習ベースのホモトピー考慮型経路計画手法。', T: '経路の曲率とケーブル基点からの距離を考慮することで、テザー付き移動ロボットのケーブルと障害物の接触を回避する経路改良手法。', U: '論文'};
	}
};
